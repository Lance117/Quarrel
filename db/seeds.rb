...
Channel.create(channel_name: 'welcome')
...
Message.create(body: "i need help!", user_id: 2, channel_id: 1)
Message.create(body: "what am i doing with my life", user_id: 2, channel_id: 1)